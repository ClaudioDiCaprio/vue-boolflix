    ...
    <div class="tvshow">
        ...
        <div class="details">
            ...
            <ul>
                ...
                <li v-if="tvshow.original_language === 'en'"><span class="tvshow-info">Language:</span> <img src="../assets/flag-united-kingdom.png" :alt="info.original_language"></li>
                <li v-else-if="tvshow.original_language === 'it'"><span class="tvshow-info">LIngua:</span> <img src="../assets/flag-italy.png" :alt="info.original_language"></li>
                <li v-else><span class="tvshow-info">Foreing Language</span> <img src="../assets/white-flag.png" alt="white_flag"></li>
